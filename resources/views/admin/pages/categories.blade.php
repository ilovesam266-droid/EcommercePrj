<div>
    ...
    <div class="row g-3">
        ...
        <!-- Total Categories -->
        <livewire:admin.components.dashboard-widget
            :title="'Total Categories'"
            :value="$totalCategories"
            :color="'primary'"
            :icon="'vendors/@coreui/icons/svg/free.svg#cil-list'"
            :chartId="'card-category-total'"
            :dropdownItems="['All']"
        />
        ...
        <livewire:admin.components.dashboard-widget
            :title="'Top Category'"
            :value="$topCategory?->categoryables_count ?? 0"
            :subtext="$topCategory?->name ?? 'No Data'"
            :color="'success'"
            :icon="'vendors/@coreui/icons/svg/free.svg#cil-chart-line'"
            :chartId="'card-top-category'"
            :dropdownItems="[$topCategory?->name ?? 'None']"
        />
        ...
        <livewire:admin.components.dashboard-widget
            ...
            :color="'warning'"
            :icon="'vendors/@coreui/icons/svg/free.svg#cil-warning'"
            :chartId="'card-unused-category'"
            :dropdownItems="['Unused']"
        />
        ...
        <livewire:admin.components.dashboard-widget
            ...
            :color="'info'"
            :icon="'vendors/@coreui/icons/svg/free.svg#cil-tags'"
            :chartId="'card-categoryables'"
            :dropdownItems="['All Assignments']"
        />
