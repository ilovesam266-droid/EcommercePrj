                    ...
                    <div class="form-section preview-section">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror"
                                id="templateTitle" placeholder="e.g., Welcome Notification" wire:model="title">
                            @error('title')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
{{-- #update is used in ckeditor by js --}}
                        <button id="update" class="btn btn-primary">Lưu Nội Dung</button>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="preview-section" style="top: 20px;">
                        ...
                        <div class="email-preview" id="notificationPreviewContainer">
                            <!-- Notification Header -->
                            ...
                            <div class="email-body">
                                <div class="email-content" id="previewContent">
                                    @if ($body)
                                        {!! $body !!}
                                    @else
                                        <p class="text-muted">Your notification content will appear here...</p>
                                    @endif
                                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const previewContainer = document.getElementById('notificationPreviewContainer');
