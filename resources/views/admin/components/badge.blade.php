...
<div class="tab-content rounded-bottom">
    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1002"><span
            class="badge me-1 bg-primary">Primary</span>
...
<!--BadgesPill badges-->
<div class="tab-content rounded-bottom">
    <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1003"><span
            class="badge me-1 rounded-pill bg-primary">Primary</span>
